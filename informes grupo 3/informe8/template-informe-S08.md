...
> [En el proyecto final aplicaría un filtro IIR a las mediciones de temperatura y humedad ambiental obtenidas mediante el sensor BME280. Elegiría un valor de α = 0.3 porque proporciona una buena reducción de ruido sin introducir un retardo excesivo. El objetivo sería evitar activaciones innecesarias del ventilador, el calefactor o el nebulizador debido a pequeñas fluctuaciones instantáneas de la medición. Para verificar la mejora, compararía la desviación estándar de la señal cruda y la señal filtrada, además de contabilizar el número de activaciones de los actuadores antes y después de aplicar el filtro. Esto demostraría cuantitativamente que el filtro IIR reduce el ruido y mejora la estabilidad de las mediciones, evitando respuestas erráticas del sistema de control ambiental.]
