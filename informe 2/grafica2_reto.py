...
plt.plot(x_ajuste, y_ajuste, color='firebrick', linewidth=2.5, label=f'Ajuste: T(t) = {parametros[1]:.2f} + ({parametros[0]:.2f} - {parametros[1]:.2f}) * exp(-0.02 * t)')
plt.scatter(x, y, color='firebrick', marker='o', s=10)
